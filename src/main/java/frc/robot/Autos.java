...
public class Autos {
    ...
    public Autos (DriveSubsystem drivetrain, ShooterSubsystem shooter, HopperSubsystem hopper, IntakeSubsystem intake) {
    ...
    */
    ...
    public Command newPath() {
        ...
        var traj1 = routine.trajectory("Driveback 1m"); // Default auto
